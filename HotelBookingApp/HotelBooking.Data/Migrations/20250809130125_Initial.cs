    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdminPanelBookings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AdminPanelBookings_Hotels_HotelModelId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_Hotels_HotelModelId",
                        column: x => x.HotelModelId,
                        principalTable: "Hotels",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_UserBookings_Bookings_BookingModelId",
            ...
            migrationBuilder.InsertData(
                table: "AspNetRoles",
                columns: new[] { "Id", "ConcurrencyStamp", "Name", "NormalizedName" },
                values: new object[] { 2, null, "Regular", "REGULAR" });

            migrationBuilder.CreateIndex(
                name: "IX_AdminPanelBookings_HotelModelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_HotelModelId",
                table: "Bookings",
                column: "HotelModelId");

            migrationBuilder.CreateIndex(
                name: "IX_UserBookings_BookingModelId",
                table: "UserBookings",
